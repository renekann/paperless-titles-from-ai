...
def get_or_create_correspondent(sess, correspondent_name, paperless_url):
    ...
    if correspondent_id:
        ...
        new_correspondent_id = create_new_correspondent(sess, correspondent_name, paperless_url)
